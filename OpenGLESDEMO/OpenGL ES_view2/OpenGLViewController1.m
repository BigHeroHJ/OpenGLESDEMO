...
- (void)setupBaseEffect
{
    ...
    _baseEffect.useConstantColor = GL_TRUE;//gl_true  就是 正常oc 中的yes no  在 opengl 中使用这些变量 来表示bool
    //A constant color, used when per-vertex color data is not provided.
    _baseEffect.constantColor = GLKVector4Make(1, 1, 1, 1);//表示 red green blue alpha
}
- (void)setupContext
{
...
- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect
{
    ...
    glVertexAttribPointer(GLKVertexAttribPosition, 3, GL_FLOAT, GL_FALSE, sizeof(positionStruct), NULL);
}
